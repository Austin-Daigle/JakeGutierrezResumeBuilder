...
class RichTextEditor(ttk.Frame):
    ...
    def _apply_style(self, *, family=None, size=None, bold=None, italic=None, underline=None, fg=None, bg=None) -> None:
        ...
        self._remove_tag_prefix_in_range("f:", start, end)
        ...
        if st.fg is not None:
            self._remove_tag_prefix_in_range("fg:", start, end)
            fg_tag = f"fg:{st.fg}"
            self.text.tag_configure(fg_tag, foreground=st.fg)
            self.text.tag_add(fg_tag, start, end)

        if st.bg is not None:
            self._remove_tag_prefix_in_range("bg:", start, end)
            bg_tag = f"bg:{st.bg}"
