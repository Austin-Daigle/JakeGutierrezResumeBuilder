    ...
    def _maybe_prompt_recover_session(self) -> None:
        ...
        if not ok:
            ...
            discard = messagebox.askyesno(
                ...
                "If you choose Yes, all recovered data will be erased.\nSelecting \"No\" will save the recovered data as a project file.",
            ...
            messagebox.showinfo(
                ...
                "The recovered data will be saved as a project file.",
